#!/bin/bash
#SBATCH -J DatcnvME         # Nombre del trabajo
#SBATCH -o /home/igarzonalva/Proyecto_SC_TNBC/SlurmOutput/GSE161529/DatcnvME%A.out       
#SBATCH -e /home/igarzonalva/Proyecto_SC_TNBC/SlurmOutput/GSE161529/DatcnvME%A.err      
#SBATCH --time=6:00:00              
...
python /home/igarzonalva/Proyecto_SC_TNBC/repos/Breast-Cancer-Heterogeneity/03InferCNV/PrepareDataMicroenvironment.py
