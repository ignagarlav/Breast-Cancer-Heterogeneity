...
export CELL_TYPE="CAF_scarches_predictions_V4"

# Run Python script with Singularity
python /home/igarzonalva/Proyecto_SC_TNBC/repos/Breast-Cancer-Heterogeneity/03LabelTransfer/FibroblastTransfer/Fibro_scanvi.py
