...
export CELL_TYPE="IGA_PostScAnvi_GenAnno_colors"

python /home/igarzonalva/Proyecto_SC_TNBC/repos/Breast-Cancer-Heterogeneity/02Integration/LatentSpaceRefinementScAnvi.py
