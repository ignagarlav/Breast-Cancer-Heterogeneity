...
adata = sc.read_h5ad(os.path.join(data_dir,"Myeloid_inital_scarches_pred.h5ad"))
...
###################### Transfer scanvi results to adata  ###########
adata.obsm[SCANVI_LATENT_KEY] = scanvi_model.get_latent_representation()
adata.obs["scanvi_scarches_predicted_labels"] = scanvi_model.predict()
...
# Guardar el objeto
adata.write_h5ad(os.path.join(data_dir,"myeloid_scanvi_schares_refinement.h5ad"))
