...
reference_adata_fname = os.path.join(adata_dir,'BREAST_fibro_tumor.h5ad')
raw_adata = sc.read_h5ad(reference_adata_fname)

### Load the query dataset
query_adata_fname = "/home/igarzonalva/Proyecto_SC_TNBC/GSE161529/Integration/adata/adata_scanvi_predictions.h5ad"
target_adata = sc.read_h5ad(query_adata_fname)

## Subset query to only myeloid cells
target_adata = target_adata[target_adata.obs.GennAnno_ScAnvi.isin(['Mesenchymal']),:].copy()
...
source_adata.obs[condition_key] = "study1"
target_adata.obs[condition_key] = "study2"
