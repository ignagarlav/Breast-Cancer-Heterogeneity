#!/bin/bash
#SBATCH -J myelarches         # Nombre del trabajo
...
#SBATCH --time=30:00:00              # Tiempo máximo
...
python /home/igarzonalva/Proyecto_SC_TNBC/repos/Breast-Cancer-Heterogeneity/LabelTransfer/MyeloidTransfer.py
